    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/departments/**").hasAnyRole("SUPER_ADMIN", "ADMIN", "EMPLOYEE")
                        .requestMatchers(HttpMethod.POST, "/api/departments/**").hasAnyRole("SUPER_ADMIN", "ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/departments/**").hasAnyRole("SUPER_ADMIN", "ADMIN")
